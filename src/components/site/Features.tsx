...
const items = [
  { icon: ShieldCheck, title: "Premium Quality", text: "Field-tested by hunters and rigorously inspected before shipping." },
  ...
  { icon: Headphones, title: "Expert Support", text: "Talk to real outfitters seven days a week, 7am – 9pm." },
];
        ...
        <Stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((it) => (
            <motion.div
              ...
              className="group p-8 border border-border bg-card hover:border-primary hover:-translate-y-1 transition-all duration-500"
            >
