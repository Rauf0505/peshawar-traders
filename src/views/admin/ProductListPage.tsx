    ...
    <div className="p-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 border border-dashed border-zinc-800 rounded-lg">
          ...
          <Link href="/admin/products/new" className="inline-flex items-center gap-2 px-4 h-9 bg-emerald-600 hover:bg-emerald-500 text-sm font-medium rounded-md transition text-white">
            <Plus className="h-4 w-4" /> Add Product
          </Link>
        </div>
      ) : (
