...
import { createSubcategory, updateSubcategory, getCategories, getSubcategories } from "@/lib/api/products.server";
...
export function SubcategoryFormPage({ editId }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.navigate({ to: "/admin/subcategories" });
    } catch (err: any) {
    ...
    <div className="p-6 max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => router.navigate({ to: "/admin/subcategories" })}
