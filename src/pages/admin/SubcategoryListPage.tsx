...
import { getSubcategories, getCategories, deleteSubcategory } from "@/lib/api/products.server";
...
export function SubcategoryListPage() {
  ...
  const isChildRoute = location.pathname.startsWith("/admin/subcategories/");
  ...
  const toggleStatus = async (sub: any) => {
    const { updateSubcategory } = await import("@/lib/api/products.server");
    try {
    ...
    <div className="p-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 border border-dashed border-zinc-800 rounded-lg">
          ...
          <Link to="/admin/subcategories/new" className="inline-flex items-center gap-2 px-4 h-9 bg-emerald-600 hover:bg-emerald-500 text-sm font-medium rounded-md transition text-white">
