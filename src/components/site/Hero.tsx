...
const HERO_IMG = "https://ik.imagekit.io/chaudaryrauf/wildwood/site/hero_txuEi3JPW.jpg";
...
export function Hero() {
  ...
  return (
    <section ref={ref} className="relative h-[65vh] min-h-[440px] md:h-[calc(100svh-5rem)] md:min-h-[600px] w-full overflow-hidden">
      <motion.div style={{ y }} className="absolute inset-0 -top-10 -bottom-10">
        <img src={HERO_IMG} alt="Hunter at golden hour" className="h-full w-full object-cover" />
