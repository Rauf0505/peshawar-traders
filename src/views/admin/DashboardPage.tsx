...
import { getProducts, getCategories, getBrands } from "@/lib/api-client";
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        <Link href="/admin/products/new" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-sm font-medium rounded-md transition text-white">
          Add Product
        </Link>
        <Link href="/admin/products" className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-sm font-medium rounded-md transition text-zinc-100">
          Manage Products
        </Link>
        <Link href="/admin/brands/new" className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-sm font-medium rounded-md transition text-zinc-100">
          Add Brand
        </Link>
        <Link href="/admin/brands" className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-sm font-medium rounded-md transition text-zinc-100">
          Manage Brands
        </Link>
      </div>
    </div>
